...
ActiveRecord::Schema.define(:version => 20121105212043) do

  create_table "customization_params", :force => true do |t|
    t.string   "name"
    t.text     "title"
    t.text     "hint"
    t.string   "type"
  ...
  create_table "customizers", :force => true do |t|
    ...
    t.datetime "created_at",             :null => false
    t.datetime "updated_at",             :null => false
    t.string   "shopfront_file_name"
    t.string   "shopfront_content_type"
    t.integer  "shopfront_file_size"
    t.datetime "shopfront_updated_at"
    t.text     "title"
    t.text     "subtitle"
    t.float    "price"
  end
  ...
  create_table "models", :force => true do |t|
    ...
    t.integer  "customizer_id"
    t.string   "model_file_file_name"
    t.string   "model_file_content_type"
    t.integer  "model_file_file_size"
    t.datetime "model_file_updated_at"
  end
  ...
  create_table "shop_themes", :force => true do |t|
    ...
    t.integer  "shopfront_file_size"
    t.datetime "shopfront_updated_at"
    t.string   "item_background_file_name"
    t.string   "item_background_content_type"
    t.integer  "item_background_file_size"
    t.datetime "item_background_updated_at"
  end
